  ...
  return (
    <>
      ...
      <main style={{ maxWidth: 600, margin: "40px auto", padding: 24 }}>
        ...
        <p>
          We use the information to improve and optimize our site, to analyze
          traffic, and to understand how users interact with our content. We may
          use third-party analytics and advertising services (such as Google
          Analytics and affiliate networks) that collect, monitor, and analyze
          this data.
        </p>
        ...
        <p>
          This site contains affiliate links. If you click on an affiliate link
          and make a purchase, we may receive a commission at no extra cost to
          you. Affiliate partners may use cookies to track your activity for
          commission purposes.
        </p>
        <h2>Your Rights</h2>
        <p>
